...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'https://fhir.ohc.network/StructureDefinition/phone-extension']) &lt;= 1">extension with URL = 'https://fhir.ohc.network/StructureDefinition/phone-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.ohc.network/StructureDefinition/current-address-extension']) &lt;= 1">extension with URL = 'https://fhir.ohc.network/StructureDefinition/current-address-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.ohc.network/StructureDefinition/permanent-address-extension']) &lt;= 1">extension with URL = 'https://fhir.ohc.network/StructureDefinition/permanent-address-extension': maximum cardinality of 'extension' is 1</sch:assert>
